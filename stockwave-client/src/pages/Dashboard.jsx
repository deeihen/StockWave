      ...
      <main className="dash-main">
        ...
        <div className="dash-content">
          ...
          <div className="stats-grid">
            <StatCard
              icon="📦" label="Total Products" value="1,248"
              sub="+12 this week" color="#1a6b3c" delay="0ms"
            />
            <StatCard
              icon="⚠️" label="Low Stock" value="4"
              sub="Needs restocking" color="#d97706" delay="80ms"
            />
            <StatCard
              icon="📥" label="Items Added" value="186"
              sub="This month" color="#2563eb" delay="160ms"
            />
            <StatCard
              icon="📤" label="Items Removed" value="94"
            ...
            <div className="chart-card wide">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <AreaChart data={stockTrend} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                  ...
                  <Area type="monotone" dataKey="value" stroke="#1a6b3c" strokeWidth={2.5} fill="url(#stockGrad)" dot={false} activeDot={{ r: 5, fill: "#1a6b3c" }}/>
                </AreaChart>
              </ResponsiveContainer>
            </div>
              ...
              <table className="activity-table">
                ...
                <tbody>
                  {recentActivity.map(a => (
                    <tr key={a.id}>
                      <td>
                        <span className={`action-badge ${a.type}`}>
                          {a.action}
                        </span>
                      </td>
