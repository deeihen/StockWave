...
export const loginWithQr    = (token) => api.post("/auth/login-qr", { token });
...
// NEW: Admin overrides a staff member's password
// Body: { newPassword: string }
export const resetStaffPassword = (id, data) => api.put(`/auth/staff/${id}/reset-password`, data);

// Any authenticated user (incl. Staff) can update their own profile
// Body: { fullName?, email?, phoneNumber?, bio? }
export const updateMyProfile = (data) => api.put("/auth/me/profile", data);